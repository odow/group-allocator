...
histogram( ~ Cumulative.GPA | factor(Allocated.Group, labels=labels_2013),
           data=manv.df, breaks=gpa_bins, ylab=ylabp,xlab=xlabp, ylim=ylimp,
...
histogram( ~ Cumulative.GPA | factor(Allocated.Group, labels=labels_2014),
           data=auto14.df, breaks=gpa_bins, ylab=ylabp,xlab=xlabp, ylim=ylimp,
           main="Automatic Allocation GPA Histogram for Groups in 2014")

# 2014 Entire Class
histogram( ~ Cumulative.GPA, data=auto14.df, breaks=gpa_bins, ylab=ylabp,xlab=xlabp, ylim=ylimp, main="GPA Histogram for 2014 Class")